...
#   SABnzbd, Prowlarr, Radarr, Sonarr, Bazarr, Cleanuparr, FileFlows, qBittorrent
...
ADMIN_SERVICES=(sabnzbd prowlarr radarr sonarr bazarr cleanuparr fileflows qbittorrent)
